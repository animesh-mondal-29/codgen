...
The purpose of this document is to explain how AndAI's codebase works. If you want build instructions instead, see [Contributing](https://github.com/voideditor/void/blob/main/HOW_TO_CONTRIBUTE.md).
...
Here's a picture of all the dependencies that are relevent between the time you first send a message through AndAI's sidebar, and the time a request is sent to your provider.
