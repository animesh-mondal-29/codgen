...
const tabNames = ['AndAI','Free', 'Paid', 'Local'] as const;
...
const descriptionOfTab: Record<TabName, string> = {
	AndAI: `AndAI offers a free tier with access to the most powerful models, and you can also bring your own keys for paid models and you can also bring your own keys for paid models.`,
...
const AddProvidersPage = ({ pageIndex, setPageIndex }: { pageIndex: number, setPageIndex: (index: number) => void }) => {
	const [currentTab, setCurrentTab] = useState<TabName>('AndAI');
...
const VoidOnboardingContent = () => {
	...
	const lastPagePrevAndNextButtons = <div className="max-w-[600px] w-full mx-auto flex flex-col items-end">
		<div className="flex items-center gap-2">
			...
			>Enter the AndAI</PrimaryActionButton>
		</div>
	</div>
		...
		0: <OnboardingPageShell
			content={
				<div className='flex flex-col items-center gap-8'>
					<div className="text-5xl font-light text-center">Welcome to AndAI</div>
