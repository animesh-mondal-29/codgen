...
export const subTextMdOfProviderName = (providerName: ProviderName): string => {
	...
	if (providerName === 'andai') return 'Get your [API Key here](https://api.andaihub.ai).'
...
export const displayInfoOfSettingName = (providerName: ProviderName, settingName: SettingName): DisplayInfo => {
	if (settingName === 'apiKey') {
		return {
			...
			placeholder: providerName === 'andai' ? 'sk-key...' :
		...
		return {
			title: providerName === 'andai' ? 'Endpoint' :
			...
			placeholder: providerName === 'andai' ? defaultProviderSettings.andai.endpoint
...
export const defaultSettingsOfProvider: SettingsOfProvider = {
	andai: {
		...
		...defaultProviderSettings.andai,
		...modelInfoOfDefaultModelNames(defaultModelsOfProvider.andai),
